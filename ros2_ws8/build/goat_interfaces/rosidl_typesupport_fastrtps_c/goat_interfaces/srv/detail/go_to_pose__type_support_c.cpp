...
#include "goat_interfaces/srv/detail/go_to_pose__rosidl_typesupport_fastrtps_c.h"
...
using _GoToPose_Request__ros_msg_type = goat_interfaces__srv__GoToPose_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _GoToPose_Request__ros_msg_type * ros_message = static_cast<_GoToPose_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr >> ros_message->x;
  }
...
static uint32_t _GoToPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_goat_interfaces__srv__GoToPose_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = goat_interfaces__srv__GoToPose_Request;
    is_plain =
      (
...
static size_t _GoToPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_goat_interfaces__srv__GoToPose_Request(
...
using _GoToPose_Response__ros_msg_type = goat_interfaces__srv__GoToPose_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _GoToPose_Response__ros_msg_type * ros_message = static_cast<_GoToPose_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_goat_interfaces__srv__GoToPose_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = goat_interfaces__srv__GoToPose_Response;
    is_plain =
      (
...
static size_t _GoToPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_goat_interfaces__srv__GoToPose_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "goat_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "goat_interfaces/srv/go_to_pose.h"
