...
{
  new (message_memory) goat_interfaces::msg::GoalPose(_init);
}

void GoalPose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<goat_interfaces::msg::GoalPose *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GoalPose_message_member_array[3] = {
  {
    ...
    offsetof(goat_interfaces::msg::GoalPose, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(goat_interfaces::msg::GoalPose, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(goat_interfaces::msg::GoalPose, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GoalPose_message_members = {
  "goat_interfaces::msg",  // message namespace
  "GoalPose",  // message name
  3,  // number of fields
  sizeof(goat_interfaces::msg::GoalPose),
...
{
  return &::goat_interfaces::msg::rosidl_typesupport_introspection_cpp::GoalPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, goat_interfaces, msg, GoalPose)() {
  return &::goat_interfaces::msg::rosidl_typesupport_introspection_cpp::GoalPose_message_type_support_handle;
}
