...
static const _GoToPose_Request_type_support_symbol_names_t _GoToPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, goat_interfaces, srv, GoToPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, goat_interfaces, srv, GoToPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, goat_interfaces, srv, GoToPose_Request)() {
  return &::goat_interfaces::srv::rosidl_typesupport_c::GoToPose_Request_message_type_support_handle;
}
...
static const _GoToPose_Response_type_support_symbol_names_t _GoToPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, goat_interfaces, srv, GoToPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, goat_interfaces, srv, GoToPose_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, goat_interfaces, srv, GoToPose_Response)() {
  return &::goat_interfaces::srv::rosidl_typesupport_c::GoToPose_Response_message_type_support_handle;
}
...
static const _GoToPose_type_support_symbol_names_t _GoToPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, goat_interfaces, srv, GoToPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, goat_interfaces, srv, GoToPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, goat_interfaces, srv, GoToPose)() {
  return &::goat_interfaces::srv::rosidl_typesupport_c::GoToPose_service_type_support_handle;
}
